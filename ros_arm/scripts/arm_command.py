...
class ArmCommand(object):
    ...
    def arm_pos_set(self, joint1=0.0, joint2=math.pi/4,
                    joint3=math.pi/2,
                    joint4=0,
                    joint5=-math.pi/4,
                    joint6=0,
    ...
    def arm_controller(self, x_direction_sign, y_direction_sign, z_direction_sign, effect=0.01):
        ...
        rospy.loginfo('get  :joint1:%s, joint2:%s, joint3:%s, joint4:%s, joint5:%s, joint6:%s', joint1, joint2, joint3, joint4, joint5, joint6)
        ...
        joint3_cal = joint3 + effect * 5 * z_direction_sign
        joint4_cal = joint4
        joint5_cal = abs(joint3) - abs(joint2) - 0.15
        joint6_cal = joint6
        rospy.loginfo('cal  :joint1:%s, joint2:%s, joint3:%s, joint4:%s, joint5:%s, joint6:%s', joint1, joint2, joint3, joint4, joint5, joint6)
        ...
        if not (self.x_at_goal and self.y_at_goal):
            self.arm_pos_set(joint1=joint1_cal, joint2=joint2_cal, joint3=joint3, joint4=joint4_cal, joint5=joint5_cal, joint6=joint6_cal)
        else:
            self.arm_pos_set(joint1=joint1_cal, joint2=joint2_cal, joint3=joint3_cal, joint4=joint4_cal, joint5=joint5_cal, joint6=joint6_cal)
