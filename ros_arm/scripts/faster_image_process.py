...
class ImgProcess(object):
    def __init__(self):
        ...
        # Publishers
        self.pub1 = rospy.Publisher('/rgb_camera/image_processed/midpoint', Float64MultiArray, queue_size=1)
        self.pub2 = rospy.Publisher('/rgb_camera/image_processed/image_range', Float64MultiArray, queue_size=1)
        self.pub3 = rospy.Publisher('/rgb_camera/image_processed/point_exist', Bool, queue_size=1)
        self.pub4 = rospy.Publisher('/rgb_camera/image_processed/joint1_position', Float64, queue_size=1)
